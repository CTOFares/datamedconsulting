...
const Testimonial = ({quote, paragraphe,Name, Position}) => {
  return (
    <div className="flex  space-y-4 p-[25px_26px] flex-col items-start gap-2.5 rounded-[15px] bg-white shadow-[0px_403px_113px_0px_rgba(23,58,109,0),0px_258px_103px_0px_rgba(23,58,109,0.01),0px_145px_87px_0px_rgba(23,58,109,0.05),0px_64px_64px_0px_rgba(23,58,109,0.09),0px_16px_35px_0px_rgba(23,58,109,0.1)]">
